    ...
    <div className="relative min-h-screen flex items-center">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 py-24">
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-12 lg:gap-24">
          ...
          {/* Right side - Shield logo placeholder */}
          <div className="flex-shrink-0">
            <div className="relative w-64 h-80 lg:w-80 lg:h-96">
              {/* Shield shape with Supabase lightning bolt */}
              <svg
                viewBox="0 0 200 240"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              ...
              >
                {/* Shield outline */}
                <path
                  d="M100 10 L180 50 L180 130 Q180 200 100 230 Q20 200 20 130 L20 50 Z"
                ...
                {/* Inner glow */}
                <path
                  d="M100 25 L165 60 L165 125 Q165 185 100 210 Q35 185 35 125 L35 60 Z"
                  fill="none"
                  stroke="var(--brand)"
                  strokeWidth="1"
                  opacity="0.3"
                ...
                <defs>
                  <linearGradient id="shieldGradient" x1="100" y1="10" x2="100" y2="230" gradientUnits="userSpaceOnUse">
                    <stop stopColor="var(--surface)" />
                    <stop offset="1" stopColor="var(--background)" />
                  </linearGradient>
                  <linearGradient id="bolt1" x1="53.9738" y1="54.974" x2="94.1635" y2="71.8295" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#249361"/>
                    <stop offset="1" stopColor="#3ECF8E"/>
                  </linearGradient>
                </defs>
